...
export interface ClientOptions {
   ...
   *
   * Defaults to process.env['SUDOPDF_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env['SUDOPDF_LOG'] or 'warn' if it isn't set.
   */
...
export class Sudopdf {
  ...
  constructor({
    ...
    this.timeout = options.timeout ?? Sudopdf.DEFAULT_TIMEOUT /* 1 minute */;
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('SUDOPDF_LOG'), "process.env['SUDOPDF_LOG']", this) ??
      defaultLogLevel;
  ...
  static SudopdfError = Errors.SudopdfError;
...
export declare namespace Sudopdf {
  ...
  export {
    Pdf as Pdf,
    type PdfGenerateResponse as PdfGenerateResponse,
    type PdfGenerateParams as PdfGenerateParams,
  };
}
